...
[![Coverage ≥94%](https://img.shields.io/badge/coverage-%E2%89%A594%25%20enforced-brightgreen.svg)](./vitest.config.ts)
...
| **Testing**                   | **187 tests** across unit / component / MSW integration / behavior snapshots / perf baselines, coverage gate **enforced in CI** (94% stmts / 84% branches / 96% funcs), Playwright e2e journeys + **axe** a11y job, deterministic Gemini fake (`tests/mocks/fake-gemini.ts`)                                                                        |
